...
extension MovieSection {
    static var movieSections: [MovieSection] {
        return [recomended, hitMovies, playnigMovies]
    }
    
    static var recomended: MovieSection {
        return MovieSection(sectionName: "Recomended for you", movies: sampleMovies.shuffled())
    }
    ...
    static var playnigMovies: MovieSection {
